...
export default function ProveedorDashboard() {
  ...
  // Lógica de filtrado por fechas dinámica
  ...
  // Cálculo financiero dinámico basado SOLO en las carreras filtradas
  let totalCreditos = 0; 
  let totalComision = 0;
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Filtro de Fechas para el Proveedor */}
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6 flex flex-col md:flex-row gap-4 items-end">
          <div className="flex-1 w-full">
            ...
            <input type="date" value={fechaInicio} onChange={(e) => setFechaInicio(e.target.value)} className="w-full px-4 py-2  border border-gray-300 rounded-lg focus:ring-2  text-black focus:ring-black outline-none" />
          </div>
          <div className="flex-1 w-full">
            <label className="block text-sm font-medium text-gray-700 mb-1">Hasta (Fecha Fin)</label>
            <input type="date" value={fechaFin} onChange={(e) => setFechaFin(e.target.value)} className="w-full px-4 py-2  border border-gray-300 rounded-lg focus:ring-2  text-black focus:ring-black outline-none" />
          </div>
